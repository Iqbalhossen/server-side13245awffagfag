...
const AdminWithdrawalAllView = async (req, res) => {
    try {
        ...
        const WithdrawalRejectSum = parseFloat(`${WithdrawalRejectArraySum[0] ? WithdrawalRejectArraySum[0].sum : 0}`);
        const WithdrawalPendingSum = parseFloat(`${WithdrawalPendingArraySum[0] ? WithdrawalPendingArraySum[0].sum : 0}`);
...
module.exports = { AdminWithdrawalMethodsView, AdminWithdrawalMethodsAdd, AdminWithdrawalMethodsInableDisable, AdminWithdrawalMethodsDelete, AdminWithdrawalMethodsEdit, AdminWithdrawalMethodsUpdate, AdminWithdrawalSingleViewById, AdminWithdrawalAllView, AdminWithdrawalAccept, AdminWithdrawalReject, AdminWithdrawalPendingView, AdminWithdrawalAcceptView, AdminWithdrawalRejectView };
